...
function library:CreateWindow(name, version, icon)
	...
	TitleUnderline.BackgroundColor3 = Color3.fromRGB(80, 80, 80)
	...
	function tabs:CreateTab(name)
		...
		function mytabbuttons:CreateFrame(name)
			...
			SearchIcon.ImageColor3 = Color3.fromRGB(80, 80, 80)

			Bar_3.Name = "Bar"
			Bar_3.Parent = SearchBar
			Bar_3.BackgroundColor3 = Color3.fromRGB(80, 80, 80)
			...
			function pagebuttons:CreateButton(name, desc, callback)
				...
				spawn(function()
					local function QCZV_fake_script() -- Caller.Handler 
						...
						Sample.ImageColor3 = Color3.fromRGB(80, 80, 80)
			...
			function pagebuttons:CreateLabel(name)
				...
				_4pxShadow2px.ImageColor3 = Color3.fromRGB(80, 80, 80)
			...
			function pagebuttons:CreateSlider(name,min,max,callback)
				...
				Indicator_3.BackgroundColor3 = Color3.fromRGB(80, 80, 80)
				...
				Shadow_1.ImageColor3 = Color3.fromRGB(80, 80, 80)
				...
				TextButton_2.BackgroundColor3 = Color3.fromRGB(80, 80, 80)
				...
				Shadow_2.ImageColor3 = Color3.fromRGB(80, 80, 80)
				...
				Fade.BackgroundColor3 = Color3.fromRGB(80, 80, 80)
			...
			function pagebuttons:CreateBox(name, icon, callback)
				...
				Footer_3.BackgroundColor3 = Color3.fromRGB(80, 80, 80)
				...
				EditIcon.ImageColor3 = Color3.fromRGB(80, 80, 80)
			...
			function pagebuttons:CreateBind(name, defaultkey, callback)
				...
				Footer_2.BackgroundColor3 = Color3.fromRGB(80, 80, 80)
